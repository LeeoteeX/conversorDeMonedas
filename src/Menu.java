        ...
        do {
            ...
            switch (opc){
                case 1:
                    ...
                    listaSolicitudes.add(new Solicitud(LocalTime.parse(LocalTime.now().format(formatearHora)),"USD","ARS"));
                break;
                case 2:
                    System.out.println("El valor de 1 Peso Argentino son " + consulta.consulta("ARS", "USD") + " Dólares");
                    listaSolicitudes.add(new Solicitud(LocalTime.parse(LocalTime.now().format(formatearHora)),"ARS","USD"));
                break;
                case 3:
                    System.out.println("El valor de 1 Dólar son " + consulta.consulta("USD","RSD") + " Reales.");
                    listaSolicitudes.add(new Solicitud(LocalTime.parse(LocalTime.now().format(formatearHora)),"USD","RSD"));
                break;
                case 4:
                    System.out.println("El valor de 1 Real es de " + consulta.consulta("RSD","USD") + " Dólares.");
                    listaSolicitudes.add(new Solicitud(LocalTime.parse(LocalTime.now().format(formatearHora)),"RSD","USD"));
                break;
                case 5:
                    System.out.println("El valor de 1 Peso Argentino son " + consulta.consulta("ARS","CLP") + " Pesos Chilenos.");
                    listaSolicitudes.add(new Solicitud(LocalTime.parse(LocalTime.now().format(formatearHora)),"ARS","CLP"));
                break;
                case 6:
                    System.out.println("El valor de 1 Peso Chileno es " + consulta.consulta("CLP","ARS") + " Pesos Argentinos.");
                    listaSolicitudes.add(new Solicitud(LocalTime.parse(LocalTime.now().format(formatearHora)),"CLP","ARS"));
                break;
                case 7:
